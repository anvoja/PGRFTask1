...
public abstract class AbstractRenderer {
    ...
    protected GLFWWindowSizeCallback windowSizeCallback = new GLFWWindowSizeCallback() {
        @Override
    ...
    protected GLFWWindowCloseCallback windowCloseCallback = new GLFWWindowCloseCallback() {
        @Override
